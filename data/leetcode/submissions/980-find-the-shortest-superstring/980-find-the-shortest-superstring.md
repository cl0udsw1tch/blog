<h1>980 - Find the Shortest Superstring</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/find-the-shortest-superstring/">find-the-shortest-superstring</a></h2><p>Given an array of strings <code>words</code>, return <em>the smallest string that contains each string in</em> <code>words</code> <em>as a substring</em>. If there are multiple valid strings of the smallest length, return <strong>any of them</strong>.</p>
